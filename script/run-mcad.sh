...
zones=("GB" "DE" "JP-KN" "CA-ON" "AU-TAS" "FR" "US-TEX-ERCO" "US-NY-NYIS" "US-CAL-CISO" "IN-EA") #geo-location of clusters
idealPower=(100 100 100 100 100 100 100 100 100 100)  #average ideal power of each cluster
peakPower=(300 300 300 300 300 300 300 300 300 300)    #average peak power of each cluster
