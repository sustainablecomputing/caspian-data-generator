...
#MCAD Runner gets as input the geo-location and power profile of the cluster and update the clusterinfo accordingly
# A sample values for 10 clusters are provided below.
