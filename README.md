...
./run-mcad.sh m 
```
For more details on how to setup the charachteristics of clsuters (such as their geo-location and power consumption profile) please look at the comments in *./run-mcad* script.